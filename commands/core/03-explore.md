...
- A previous `/titan:07-verify` flagged unknowns or knowledge gaps
...
> Generated by /titan:03-explore on [date]
...
- **Before `/titan:05-plan`:** Ensure the phase's approach is well-understood
- **Triggered by `/titan:07-verify`:** When verification flags knowledge gaps
