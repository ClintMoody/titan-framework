...
# /titan:explore — Exploration & Research
...
- `.titan/PROJECT.md` exists (run `/titan:vision` first, or at minimum have a clear project direction)
...
- A previous `/titan:verify` flagged unknowns or knowledge gaps
...
> Generated by /titan:explore on [date]
...
╚══════════════════════════════════════════════════════════════╝
  ...
  - If ready to build: /titan:plan to create execution plan
  - If UI needed: /titan:design for mockups
  - If deeper analysis needed: /titan:investigate
  - If more research needed: /titan:explore again
  ─────────────────────────────────────────────────
```
...
- **After `/titan:vision`:** Explore unknowns identified during architecture discussion
- **Before `/titan:plan`:** Ensure the phase's approach is well-understood
- **Triggered by `/titan:verify`:** When verification flags knowledge gaps
