...
1. **Context Budget** -- Each task must fit within 50% of the context window. Estimate by counting files to read + files to modify + description complexity. If a task requires reading >5 files, it is too large.
