...
description: "TITAN Framework agent — follows the Golden Path workflow for AI-assisted software development"
tools:
  - read_file
  - write_file
  - edit_file
...
# ⚡ TITAN Framework — Project Rules for OpenCode Agents
...
If a task feels too big, decompose further during planning.
